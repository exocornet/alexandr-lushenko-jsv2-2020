...
let mult = 12 * 12;
document.getElementById('two').innerHTML = `${mult}`;
...
document.querySelector('.three').innerHTML = `<h3>H3 с произвольным текстом</h3>`;
...
let dropInDiv = document.querySelector('.four');
dropInDiv.innerHTML = `<h4>H4 с произвольным текстом</h4>`;
dropInDiv.innerHTML += `<p>Параграф с произвольным тектом</p>`;
...
let z2 = 3;
let multi = z1 * z2;
document.querySelector('.mult').innerHTML = `${multi}`;
...
// document.querySelector('body').innerHTML = ''; //все стерло