...
function f2() {
  if (a21 > a22) {
    document.querySelector('.out-2').innerHTML = `a21 больше a22. Число ${a21}`;
  } else {
    document.querySelector('.out-2').innerHTML = `a22 больше a21. Число ${a22}`;
  }
}
...
function f4() {
  ...
  let age = new Date().getFullYear() - i4;

  if (age >= 18) {
    document.querySelector('.out-4').innerHTML = `1 <br> тебе ${age} лет`;
  } else {
    document.querySelector('.out-4').innerHTML = `0 <br> тебе ${age} лет`;
  }
}
...
function f5() {
  ...
  let viewWindow = document.querySelector('.out-5');

  if (i5 < 0) {
    viewWindow.innerHTML = 'm';
  } else if (i5 === 0) {
    viewWindow.innerHTML = '0';
  } else {
    viewWindow.innerHTML = '1';
  }
}
...
function f8() {
  ...
  let viewWindow = document.querySelector('.out-8');

  switch (s8) {
    case '1':
      viewWindow.innerHTML = 'one';
      break;

    case '2':
      viewWindow.innerHTML = 'two';
      break;

    case '3':
      viewWindow.innerHTML = 'three';
      break;
  }
}
...
function f9() {
  ...
  let viewWindow = document.querySelector('.out-9');

  if (i9 < 33 && i9 > 0) {
    viewWindow.innerHTML = '1';
  } else if (i9 > 32 && i9 < 44) {
    viewWindow.innerHTML = '2';
  } else if (i9 > 43 && i9 < 65) {
    viewWindow.innerHTML = '3';
  } else {
    viewWindow.innerHTML = '0';
  }
...
function f14() {
  ...
  let viewWindow = document.querySelector('.out-14');

  switch (s143){
    case '+':
      viewWindow.innerHTML = i141 + i142;
      break;
    case '-':
      viewWindow.innerHTML = i141 - i142;
      break;
...
function f15() {
  ...
  let viewWindow = document.querySelector('.out-15');
  let s = s151 + s153 + s152;
  ...
  switch (s) {
    ...
    case '0||1':
    case '1||0':
      viewWindow.innerHTML = +true;
      break;
    case '1&&0':
    case '0&&1':
    case '0&&0':
    case '0||0':
      viewWindow.innerHTML = +false;
      break;
  }
}
