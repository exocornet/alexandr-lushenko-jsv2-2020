...
let arr1 = ['Nina', 'Вася', 3, false, 66, true, 'кот'];
...
let arr2 = ['Nina', 'Вася', 3, false, 66, true, 'кот'];
...
let arr3 = ['Nina', 'Вася', 3, false, 66, true, 'кот'];
let out3 = document.querySelector('.out-3');

function f3() {
    out3.innerHTML = arr3.length;
}
...
// let ar5 =
let arr5 = [2, 3, 5, 6, 9, 4];
let out5 = document.querySelector('.out-5');

function f5() {
    out5.innerHTML = arr5[0] + arr5[2] + arr5[3];
}
...
// let ar6 =
let arr6 = ['Евгений', 'Стрелец', 27, 11];
...
let ar15 = [0, 2, 5, -4, 6, 222, -9, -12, 8, 12, 13, 78];
...
function f16() {
    ...
    for (let i = 0; i < ar16_even.length; i++) {
        if (ar16_even[i] !== undefined) {
            divEvent += `${ar16_even[i]} `;
        }
    }

    let divOdd = '';
    for (let i = 0; i < ar16_odd.length; i++) {
        if (ar16_odd[i] !== undefined) {
            divOdd += `${ar16_odd[i]} `;
        }
    }

    out16Even.innerHTML = divEvent;
    out16Odd.innerHTML = divOdd;
}
...
let ar17 = [33, 0, 2, 6, 0, 1, 3, 10, 9, 0, 2, 0];
