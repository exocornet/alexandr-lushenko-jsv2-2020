...
function f4() {
    ...
    let viewWindow = document.querySelector('.out-4');
...
function f7() {
    ...
    let viewWindow1 = document.querySelector('.out-71');
    let viewWindow2 = document.querySelector('.out-72');

    if (i7.length >= 6) {
        viewWindow1.innerHTML = i7;
        viewWindow2.innerHTML = `1`;
    } else {
        viewWindow1.innerHTML = i7;
        viewWindow2.innerHTML = `0`;
    }
}
...
function f8() {
   ...
   let divOut8 = document.querySelector('.out-8');
    ...
    divOut8.innerHTML = `<input class="i-81"> <button class="b-81">TASK</button>`;
...
// Task 14
// Создайте text-area.t-14 и button.b-14 - при нажатии на кнопку выводите в out-14 текст введенный в t-14.
...
function f20(e) {
    ...
    document.querySelector('.out-20').innerHTML = `${name} ${pass}`;
}
